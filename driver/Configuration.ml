...
let _ =
  try Readconfig.read_config_file "" with
...
let prepro = get_config_list "prepro" @ opt_config_list "prepro_options"
let asm = get_config_list "asm" @ opt_config_list "asm_options"
let linker = get_config_list "linker" @ opt_config_list "linker_options"
