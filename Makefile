...
# Dlib.v Dom.v DomTest.v
CFRONTEND=Ctypes.v Cop.v ClightCFG.v RustLight.v RustLightgen.v \
	RustLightSplitExpr.v RustLightInsertTypeCasts.v RustLightModifyMain.v \
  Csyntax.v Csem.v Ctyping.v Cstrategy.v Cexec.v \
...
# TODO this should contain the clightcfg stuff
ifeq ($(CLIGHTGEN),true)
EXPORTLIB=Ctypesdefs.v Clightdefs.v Csyntaxdefs.v RustLight.v
else
EXPORTLIB=
endif
